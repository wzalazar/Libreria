 ...
 * @author Facundo
 */
@WebServlet(name = "dashboard_carrito", urlPatterns = {"/dashboard_carrito"})
public class dashboard_carrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            RequestDispatcher carrito = request.getRequestDispatcher("carrito");
            carrito.include(request, response);
