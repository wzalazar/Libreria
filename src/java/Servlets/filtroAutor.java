 ...
 * @author Facundo
 */
@WebServlet(name = "filtroAutor", urlPatterns = {"/filtroAutor"})
public class filtroAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       libroControladora olibroControladora = new libroControladora();
        ...
        try
        {
            ...
            Hashtable ListaLibros = oDatosLibros.ListarLibrosAutor(autor);            
