 ...
 * @author Facundo
 */
@WebServlet(name = "mensajeCrearLibroCorrecto", urlPatterns = {"/mensajeCrearLibroCorrecto"})
public class mensajeCrearLibroCorrecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            mensajeCorrecto.include(request, response);
              out.println("<div style=\"position: absolute; left: 50%; top: 320px; margin-left: -208px; width: 258px;\"><a href=\"CargaLibro\" title=\"Volver\" style=\"float:right;margin-top:10px;\"><button class=\"btn btn-red5\">Volver a carga libro</button></a></div>"
                    );
