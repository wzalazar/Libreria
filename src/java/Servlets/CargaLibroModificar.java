 ...
 * @author Facundo
 */
@WebServlet(name = "CargaLibroModificar", urlPatterns = {"/CargaLibroModificar"})
public class CargaLibroModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher formulario_libro_modificar = request.getRequestDispatcher("formulario_libro_modificar");
