 ...
 * @author Facundo
 */
@WebServlet(name = "CargaLibroCarritoFiltroGenero", urlPatterns = {"/CargaLibroCarritoFiltroGenero"})
public class CargaLibroCarritoFiltroGenero extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher filtroGenero = request.getRequestDispatcher("filtroGenero");
            filtroGenero.include(request, response);
