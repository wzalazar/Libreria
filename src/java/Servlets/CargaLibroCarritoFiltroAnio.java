 ...
 * @author Facundo
 */
@WebServlet(name = "CargaLibroCarritoFiltroAnio", urlPatterns = {"/CargaLibroCarritoFiltroAnio"})
public class CargaLibroCarritoFiltroAnio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher filtroAño = request.getRequestDispatcher("filtroAnio");
            filtroAño.include(request, response);
