 ...
 * @author Facundo
 */
@WebServlet(name = "CargaLibroCarritoFiltroAutor", urlPatterns = {"/CargaLibroCarritoFiltroAutor"})
public class CargaLibroCarritoFiltroAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher filtroAutor = request.getRequestDispatcher("filtroAutor");
            filtroAutor.include(request, response);
