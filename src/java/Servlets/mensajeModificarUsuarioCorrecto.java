 ...
 * @author Facundo
 */
@WebServlet(name = "mensajeModificarUsuarioCorrecto", urlPatterns = {"/mensajeModificarUsuarioCorrecto"})
public class mensajeModificarUsuarioCorrecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            mensajeCorrecto.include(request, response);
              out.println("<div style=\"position: absolute; left: 50%; top: 320px; margin-left: -208px; width: 258px;\"><a href=\"VerCliente\" title=\"Volver\" style=\"float:right;margin-top:10px;\"><button class=\"btn btn-red5\">Volver a modificar cliente</button></a></div>"
                    );
