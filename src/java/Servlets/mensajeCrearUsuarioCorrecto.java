 ...
 * @author Facundo
 */
@WebServlet(name = "mensajeCrearUsuarioCorrecto", urlPatterns = {"/mensajeCrearUsuarioCorrecto"})
public class mensajeCrearUsuarioCorrecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            mensajeCorrecto.include(request, response);
              out.println("<div style=\"position: absolute; left: 50%; top: 320px; margin-left: -208px; width: 258px;\"><a href=\"CargaCliente\" title=\"Volver\" style=\"float:right;margin-top:10px;\"><button class=\"btn btn-red5\">Volver a carga cliente</button></a></div>"
                    );
