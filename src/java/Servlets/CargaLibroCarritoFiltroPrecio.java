 ...
 * @author Facundo
 */
@WebServlet(name = "CargaLibroCarritoFiltroPrecio", urlPatterns = {"/CargaLibroCarritoFiltroPrecio"})
public class CargaLibroCarritoFiltroPrecio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher filtroPrecio = request.getRequestDispatcher("filtroPrecio");
            filtroPrecio.include(request, response);
