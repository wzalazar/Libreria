 ...
 */
@WebServlet(name = "CargaClienteModificar", urlPatterns =
{
    "/CargaClienteModificar"
})
public class CargaClienteModificar extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            RequestDispatcher formulario_libro_modificar = request.getRequestDispatcher("formulario_cliente_modificar");
            formulario_libro_modificar.include(request, response);
